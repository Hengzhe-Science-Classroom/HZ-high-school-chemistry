// === High School Chemistry - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('hs-chemistry-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('hs-chemistry-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
